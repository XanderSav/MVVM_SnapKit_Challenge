...
protocol DataStorage {
    var updateListener: PublishSubject<(String, PieceModel)> { get }
    var observableData: BehaviorRelay<[PieceModel]> { get }
//    func getData() -> [PieceModel]
//    func updateModel(named: String, with newValue: PieceModel)
}

class LocalDataStorage : DataStorage {
    var updateListener = PublishSubject<(String, PieceModel)>()
    var observableData: BehaviorRelay<[PieceModel]>
    private let disposeBag = DisposeBag()
    
    private var data: [PieceModel]
    
    private func getData() -> [PieceModel] {
        return data
    }
    
    private func updateModel(named oldName: String, with newValue: PieceModel)
    {
